...
### 1. Bootstrap project and quality gates
...
### 2. Define and validate the cross-language protocol
...
### 3. Implement helper lifecycle and session reducer
...
### 4. Implement display coordinates, permissions and AppKit selection overlay
...
### 5. Implement CoreGraphics capture backend
...
### 6. Implement atomic tile session store and recovery
...
### 7. Implement overlap and static-region stitching engine
...
### 8. Implement manual and automatic scroll controllers
...
### 9. Build the capture UI and complete MVP integration
...
### 10. Generate preview pyramid and viewport tile bridge
...
### 11. Implement non-destructive editor and history
...
### 12. Implement strip-based native rendering and formats
...
### 13. Complete destinations, clipboard and persistent settings
...
### 14. Add privacy-safe diagnostics and recovery UX
...
### 15. Build Universal, packaging, signing and notarization paths
...
### 16. Run automated performance and correctness qualification
...
### 17. Complete application and OS compatibility matrix
...
### 18. Final documentation and release readiness
